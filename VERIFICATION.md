...
Verified locally on September 9, 2026, against Omarchy 4.0.3-1 and the
...
- 24 QML fixture assertions pass, including native widget/panel loading,
  ...
  keyboard typing/navigation/Escape, and failure-state preservation.
...
All six application/display checks passed. Search, source expansion, system
item filtering, panel bounds, application icons, and startup/running-state
separation were inspected. Current runtime logs contain no omastart warnings
