...
Item {
    ...
    Shape {
        ...
        ShapePath {
            ...
            PathSvg {
                path: "M 4.3 15.3 C 8.3 11.3 12 7.5 12 5.5 "
                    + "L 9.2 8.3 Q 8.5 9 7.8 8.3 Q 7.1 7.6 7.8 6.9 "
                    + "L 12.3 2.4 Q 13 1.7 13.7 2.4 "
                    + "L 18.2 6.9 Q 18.9 7.6 18.2 8.3 Q 17.5 9 16.8 8.3 "
                    + "L 14 5.5 C 14 8.3 9.7 12.7 5.7 16.7 "
                    + "Q 5 17.4 4.3 16.7 Q 3.6 16 4.3 15.3 Z"
            }
        }
        ShapePath {
            strokeWidth: -1
            fillColor: root.foreground
            PathSvg { path: "M 4 19.5 H 20 A 1 1 0 0 1 20 21.5 H 4 A 1 1 0 0 1 4 19.5 Z" }
        }
    }
}
